<section class="panel">
    <header class="panel-heading">
        <h2 class="panel-title">Edit doctor</h2>
    </header>
          ...
          <div class="padd">
            <?php
                ...
                <div class="row">
                	<div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                            <input type="text" class="form-control" name="doctor_fname" placeholder="First name" value="<?php echo $doctor_row->doctor_fname;?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4" for="doctor_fname">Other names</label>
                            <div class="col-md-8">
                            <input type="text" class="form-control" name="doctor_onames" placeholder="Other names" value="<?php echo $doctor_row->doctor_onames;?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4" for="doctor_fname">Email</label>
                            <div class="col-md-8">
                            <input type="text" class="form-control" name="doctor_email" placeholder="Email" value="<?php echo $doctor_row->doctor_email;?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4" for="doctor_fname">Phone</label>
                            <div class="col-md-8">
                            <input type="text" class="form-control" name="doctor_phone" placeholder="Phone" value="<?php echo $doctor_row->doctor_phone;?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4" for="doctor_fname">Designation</label>
                            <div class="col-md-8">
                            <input type="text" class="form-control" name="doctor_title" placeholder="Designation" value="<?php echo $doctor_row->doctor_title;?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4" for="doctor_fname">Qualifications</label>
                            <div class="col-md-8">
                            <input type="text" class="form-control" name="doctor_qualifications" placeholder="Qualifications" value="<?php echo $doctor_row->doctor_qualifications;?>">
                            </div>
                        </div>
					</div>
                	<div class="col-md-6">
                        <label class="control-label" for="image">Doctor Image</label>
                ...
                <div class="row">
                	<div class="col-md-12">
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="doctor_description">Doctor description</label>
                            <div class="col-md-10" style="height:500px; margin-bottom:20px;">
                            	<textarea class="cleditor" name="doctor_about"><?php echo $doctor_row->doctor_about;?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
