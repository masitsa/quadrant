          ...
          <div class="padd">
            <?php
                ...
                <div class="row">
                	<div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="training_name" placeholder="Training Name" value="<?php echo set_value("training_name");?>">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <div id="datetimepicker1" class="input-append">
                                    <input data-format="yyyy-MM-dd" class="form-control" type="text" name="start_date" placeholder="Post Date" value="<?php echo set_value('start_date');?>">
                                    <span class="add-on">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <div id="datetimepicker3" class="input-append">
                                    <input data-format="yyyy-MM-dd" class="form-control" type="text" name="end_date" placeholder="Post Date" value="<?php echo set_value('end_date');?>">
                                    <span class="add-on">
                                        &nbsp;<i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                        </i>
                                    </span>
                	...
                	<div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-10" style="height:500px; margin-bottom:20px;">
                            	<textarea class="cleditor" name="training_description"><?php echo set_value("training_description");?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
				...
				<div class="form-group center-align">
					<input type="submit" value="Add Training" class="login_btn btn btn-success btn-lg">
				</div>
				<?php
					echo form_close();
				?>
