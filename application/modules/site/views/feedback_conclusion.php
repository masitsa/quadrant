...
<section class="sub-banner">
    <div class="container">
        <div class="position-center-center">
            <h2>Training Needs Analysis Feedback</h2>
            <ul class="breadcrumb">
    ...
    <section class="intro padding-top-100 padding-bottom-100">
        <div class="container"> 
            ...
            <div class="heading-block text-center margin-bottom-80">
                ...
                <span>Thank you for completing the TNA feedback. We hope you enjoyed this session. The advanced training is coming soon. See you there.</span>
