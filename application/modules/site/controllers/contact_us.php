	...
	*/
	public function book_appointment() 
	{
		...
		if ($this->form_validation->run())
		{
			...
			';
			$sender_email = 'trainings@quadrantafrica.co.ke';
			$shopping = "";
			$from = $full_name;
	...
	*/
	public function contact($page = 1) 
	{
		...
		if ($this->form_validation->run())
		{
			...
			$button = '';
			$response = $this->email_model->send_mandrill_mail('trainings@quadrantafrica.co.ke', "Hi ", $subject, $message, $sender_email, $shopping, $from, $button, $cc = NULL);
			...
			$button = '';
			$response2 = $this->email_model->send_mandrill_mail($email, "Hi ".$first_name, $subject, $message, 'trainings@quadrantafrica.co.ke', $shopping, $from, $button, $cc = NULL);
